...
% DOCUMENT START
% ==========================================================================
\title{Prediction-Powered Inference with Missing Data\\ \large(Adapting Pre-trained Models for Finite Population Inference)}
\author{Hanan Ather}
\date{December 2025}
...
\todo[inline, color=orange]{Strategy: Start with the Historical Data scenario.}
\todo[inline, color=green]{Status: Tables are fixed, Notation is standardized to 'k' and totals.}

% Imports from my other files
% \include{paper/background}
\include{paper/v0}
%\include{paper/appendix/tables-Hanan}
